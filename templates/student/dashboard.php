...
<head>
    ...
    <title>Student Dashboard - ระบบฝึกงาน</title>
    ...
    <main class="py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="mb-6 md:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">ยินดีต้อนรับ, <?= htmlspecialchars($_SESSION['user']['full_name']) ?></h1>
                    <p class="text-sm md:text-base text-gray-600 mt-1">รหัสนิสิต: <?= htmlspecialchars($student['student_id']) ?> | สาขา: <?= htmlspecialchars($student['major']) ?></p>
                </div>
                <a href="index.php?page=internships" class="w-full sm:w-auto bg-blue-600 text-white px-4 md:px-6 py-2.5 rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-500/30 flex items-center justify-center gap-2 text-sm md:text-base">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                    <span>ค้นหาสถานที่ฝึกงาน</span>
                </a>
            </div>
